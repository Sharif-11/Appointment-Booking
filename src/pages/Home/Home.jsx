    ...
    <div className="mt-16">
      ...
      {/* <div className="container1 mt-[5%] flex mx-auto my-3 items-stretch justify-center h-auto">
        <div className="left w-1/4 mx-[2%] py-3 card transform transition-transform group hover:-translate-y-1 hover:scale-105">
          <div className="flex flex-col items-center text-center card-body h-full">
            ...
            <p className="font-bold text-xl text-gray-600 py-3">
              Electrocardiogram (ECG/EKG)
            </p>
            <p className="text-justify">
              This test records the electrical activity of the heart over a
              period of time. It helps diagnose irregular heart rhythms and
              heart attacks.
            </p>
          </div>
        </div>
        ...
        <div className="middle w-1/4 mx-[2%] card transform transition-transform group hover:-translate-y-1 hover:scale-105">
          <div className="flex flex-col items-center text-center card-body h-full">
            ...
            <p className="font-bold text-xl text-gray-600 py-3 text-center">
              Echocardiogram
            </p>
            <p className="text-justify">
              An echocardiogram uses sound waves (ultrasound) to create images
              of the heart. It provides detailed information about the heart's
        ...
        <div className="right w-1/4 mx-[2%] card transform transition-transform group hover:-translate-y-1 hover:scale-105">
          <div className="flex flex-col items-center text-center card-body h-full">
            ...
            <p className="text-justify">
              A stress test, often done on a treadmill or stationary bike,
      ...
      {/* <div className="container2 mt-30 flex mx-auto items-center justify-center ">
        <div className="left w-1/2">
          <h1 className="text-gray-600 font-bold py-3">
            About Dr X<br />
          </h1>
          <p className="py-3 text-justify">
            {" "}
            Welcome to the prestigious Cardiology Practice of Dr. X, which is
            run by a renowned cardiologist with significant training and a
            dedication to providing advanced care. With the aid of modern
            equipment,
            <br /> Dr. X's patient-centered approach customizes treatments for
            your particular cardiac needs. Choose us <br /> for superior cardiac
            diagnostics, quick access to innovative cardiac therapies, and
            information on <br /> leading a heart-healthy lifestyle. When you're
            ready to put your heart health first, explore our website <br /> for
            information on our services. We're then here to help you make an
            appointment. With us, your path <br /> to a heart that is healthy
            can begin.
          </p>
          <Link
            to="/about"
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <h1 className="font-bold py-3 text-white">
                  Get monthly health tips from Dr. X
                </h1>
                <p className="py-3 text-white">
                  Join our group to get easy access to tons of helpful heart
                  health advice, suggestions <br /> and the most recent
                  information sent straight to your inbox for your wellbeing.
                </p>
              </div>
            </div>
          </div>
